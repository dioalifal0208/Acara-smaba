import{r as j,j as t,H as T,f as B}from"./app-DHT7f-7O.js";import{A as C}from"./AuthenticatedLayout-Bk-N7bVX.js";import"./transition-oY7H_YdQ.js";function W({workcodes:u=[],selectedWorkcodeId:c,selectedWorkcode:s,stats:o,attendances:w=[]}){const[h,v]=j.useState(""),[m,k]=j.useState(""),N=[...new Set(w.map(e=>e.status_pegawai).filter(Boolean))].sort(),z=e=>{B.get(route("report"),{workcode_id:e},{preserveState:!0,preserveScroll:!0})},g=w.filter(e=>{const n=e.nama.toLowerCase().includes(h.toLowerCase())||e.nis_nip.toLowerCase().includes(h.toLowerCase()),d=m===""||e.status_pegawai===m;return n&&d}),f=o.total>0?Math.round(o.hadir/o.total*100):0,A=()=>{if(!s)return;const e=window.open("","_blank","width=800,height=900"),n=g.map((a,p)=>`
            <tr>
                <td style="text-align: center; padding: 7px 8px; border: 1px solid #cbd5e1; font-size: 11px;">${p+1}</td>
        ...
        `).join(""),d=s.kategori==="harian"?`
            ...
            <html>
            <head>
                <title>Rekap Presensi - ${s.nama_workcode}</title>
                <style>
                    @page {
                        size: A4 portrait;
                        margin: 2.5cm;
            ...
            <body>
                ...
                <div class="meta-info">
                    <table>
                        <tr>
                            ...
                            <td style="font-weight: bold;">${s.nama_workcode}</td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold;">Total Kehadiran</td>
                            <td>:</td>
                            <td>${o.hadir} dari ${o.total} peserta (${f}%)</td>
                        </tr>
                        <tr>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ${n||'<tr><td colspan="10" style="text-align:center; padding: 10px;">Belum ada data kehadiran</td></tr>'}
                    </tbody>
                </table>
                ...
                <div class="ttd-section">
                    <div class="ttd-box">
                        ...
                        <div class="ttd-qr-wrap" style="display: flex; justify-content: center; margin: 10px 0;">
                            <img src="/workcodes/${s.id}/qr-signature" style="width: 80px; height: 80px;" alt="QR TTD" />
                        </div>
        ...
        `),e.document.close()},S=async(e,n)=>{if(s)try{const a=await(await fetch(`/report/individual/${s.id}/${e}`)).json(),p=window.open("","_blank","width=800,height=900"),_=a.attendances.map((i,M)=>{let l="-",y="-",b="-";if(i.waktu_hadir&&i.waktu_hadir!=="-"){const r=i.waktu_hadir.split(" ");if(r.length>=4){l=r.slice(0,3).join(" "),y=r[3];const x=new Date(l);isNaN(x)||(l=`${x.toLocaleDateString("id-ID",{weekday:"long"})}, ${l}`)}else l=i.waktu_hadir}if(i.waktu_pulang&&i.waktu_pulang!=="-"){const r=i.waktu_pulang.split(" ");if(r.length>=4){if(b=r[3],l==="-"){l=r.slice(0,3).join(" ");const x=new Date(l);isNaN(x)||(l=`${x.toLocaleDateString("id-ID",{weekday:"long"})}, ${l}`)}}else b=i.waktu_pulang}return`
                    <tr>
                        <td style="text-align: center; padding: 7px 8px; border: 1px solid #cbd5e1; font-size: 11px;">${M+1}</td>
                        <td style="text-align: center; padding: 7px 8px; border: 1px solid #cbd5e1; font-size: 11px;">${l}</td>
                        <td style="text-align: center; padding: 7px 8px; border: 1px solid #cbd5e1; font-size: 11px;">${y}</td>
                        <td style="text-align: center; padding: 7px 8px; border: 1px solid #cbd5e1; font-size: 11px;">${b}</td>
                        <td style="text-align: center; padding: 7px 8px; border: 1px solid #cbd5e1; font-weight: bold; font-size: 11px;">${a.participant.status||"-"}</td>
                    </tr>
                `}).join(""),$=a.attendances.filter(i=>i.status==="alpha").length,L=a.attendances.filter(i=>i.status==="izin").length,I=a.attendances.filter(i=>i.status==="sakit").length,P=a.attendances.filter(i=>i.status==="lupa_absen").length,H=a.attendances.filter(i=>i.status==="hadir").length;p.document.write(`
                <!DOCTYPE html>
                <html>
                <head>
                ...
                <body>
                    ...
                    <div class="meta-info">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>${a.workcode.nama_workcode}</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <table class="data-table" style="margin-bottom: 15px;">
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding: 7px 8px; border: 1px solid #cbd5e1; font-size: 11px; font-weight: bold; color: #dc2626;">${$}</td>
                                <td style="text-align: center; padding: 7px 8px; border: 1px solid #cbd5e1; font-size: 11px; font-weight: bold; color: #d97706;">${L}</td>
                                <td style="text-align: center; padding: 7px 8px; border: 1px solid #cbd5e1; font-size: 11px; font-weight: bold; color: #2563eb;">${I}</td>
                                <td style="text-align: center; padding: 7px 8px; border: 1px solid #cbd5e1; font-size: 11px; font-weight: bold; color: #475569;">${P}</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ${_||'<tr><td colspan="5" style="text-align:center; padding: 10px;">Belum ada data kehadiran</td></tr>'}
                        </tbody>
                    </table>
            ...
            `),p.document.close()}catch(d){console.error("Gagal mengambil data rekap:",d),alert("Terjadi kesalahan saat memuat rekap individu.")}};return t.jsxs(C,{header:t.jsxs("div",{className:"flex flex-col sm:flex-row sm:items-center justify-between gap-4","data-aos":"fade-down",children:[t.jsxs("div",{children:[t.jsx("h2",{className:"text-xl font-extrabold leading-tight text-slate-800",children:"Laporan Kehadiran"}),t.jsx("p",{className:"text-xs text-slate-500 font-medium mt-0.5",children:s?`Menampilkan laporan untuk: ${s.nama_workcode}`:"Pilih workcode untuk melihat data"})]}),t.jsxs("div",{className:"flex flex-wrap items-center gap-2.5",children:[t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx("label",{htmlFor:"workcode-filter",className:"text-xs font-bold text-slate-600 shrink-0",children:"Workcode:"}),t.jsxs("select",{id:"workcode-filter",value:c||"",onChange:e=>z(e.target.value),className:"rounded-xl border border-slate-200 bg-white py-2 px-3 text-xs font-bold text-indigo-700 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/10 cursor-pointer min-w-[170px]",children:[u.length===0&&t.jsx("option",{value:"",children:"Belum Ada Workcode"}),u.map(e=>t.jsxs("option",{value:e.id,children:[e.is_active?"🟢 ":"",e.nama_workcode," (",e.attendances_count," hadir)"]},e.id))]})]}),c&&t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsxs("a",{href:route("workcodes.export",c),className:"inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-xs font-bold text-emerald-700 hover:bg-emerald-50 hover:border-emerald-200 shadow-sm transition-all active:scale-95",children:[t.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-4 w-4 text-emerald-600",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:t.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"})}),"Export Excel (.xlsx)"]}),t.jsxs("button",{type:"button",onClick:A,className:"inline-flex items-center gap-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 px-3.5 py-2 text-xs font-bold text-white shadow-sm transition-all active:scale-95",children:[t.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-4 w-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:t.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"})}),"Cetak Bukti Hadir"]})]})]})]}),children:[t.jsx(T,{title:"Laporan Kehadiran"}),t.jsx("div",{className:"py-4 px-4 sm:px-6 lg:px-8 flex-1 flex flex-col overflow-hidden justify-between max-h-[580px]",children:t.jsxs("div",{className:"mx-auto max-w-7xl w-full flex-1 flex flex-col overflow-hidden space-y-4",children:[t.jsxs("div",{className:"mb-2 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 flex-none","data-aos":"fade-up",children:[t.jsx("div",{className:"overflow-hidden rounded-xl bg-white border border-slate-200 p-4 shadow-sm",children:t.jsxs("div",{className:"flex items-center gap-4",children:[t.jsx("div",{className:"rounded-xl bg-indigo-50 border border-indigo-100 p-2.5",children:t.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-6 w-6 text-indigo-700",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:t.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"})})}),t.jsxs("div",{children:[t.jsx("p",{className:"text-[10px] font-semibold text-slate-500 uppercase tracking-wider",children:"Total Peserta"}),t.jsx("p",{className:"text-xl font-extrabold text-slate-800 mt-0.5",children:o.total})]})]})}),t.jsx("div",{className:"overflow-hidden rounded-xl bg-white border border-slate-200 p-4 shadow-sm",children:t.jsxs("div",{className:"flex items-center gap-4",children:[t.jsx("div",{className:"rounded-xl bg-emerald-50 border border-emerald-100 p-2.5",children:t.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-6 w-6 text-emerald-600",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:t.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"})})}),t.jsxs("div",{children:[t.jsx("p",{className:"text-[10px] font-semibold text-slate-500 uppercase tracking-wider",children:"Hadir"}),t.jsx("p",{className:"text-xl font-extrabold text-emerald-600 mt-0.5",children:o.hadir})]})]})}),t.jsx("div",{className:"overflow-hidden rounded-xl bg-white border border-slate-200 p-4 shadow-sm",children:t.jsxs("div",{className:"flex items-center gap-4",children:[t.jsx("div",{className:"rounded-xl bg-amber-50 border border-amber-100 p-2.5",children:t.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-6 w-6 text-amber-600",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:t.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"})})}),t.jsxs("div",{children:[t.jsx("p",{className:"text-[10px] font-semibold text-slate-500 uppercase tracking-wider",children:"Belum Hadir"}),t.jsx("p",{className:"text-xl font-extrabold text-amber-600 mt-0.5",children:o.belum})]})]})}),t.jsx("div",{className:"overflow-hidden rounded-xl bg-white border border-slate-200 p-4 shadow-sm",children:t.jsxs("div",{className:"flex items-center gap-4",children:[t.jsx("div",{className:"rounded-xl bg-purple-50 border border-purple-100 p-2.5",children:t.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-6 w-6 text-purple-600",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:[t.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"}),t.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"})]})}),t.jsxs("div",{children:[t.jsx("p",{className:"text-[10px] font-semibold text-slate-500 uppercase tracking-wider",children:"Persentase"}),t.jsxs("p",{className:"text-xl font-extrabold text-purple-600 mt-0.5",children:[f,"%"]})]})]})})]}),t.jsxs("div",{className:"overflow-hidden rounded-xl bg-white border border-slate-200 p-4 shadow-sm flex-none","data-aos":"fade-up","data-aos-delay":"100",children:[t.jsxs("div",{className:"mb-2 flex items-center justify-between",children:[t.jsx("span",{className:"text-xs font-bold text-slate-700",children:"Progress Kehadiran"}),t.jsxs("span",{className:"text-xs font-bold text-indigo-600",children:[o.hadir," / ",o.total]})]}),t.jsx("div",{className:"h-2.5 w-full overflow-hidden rounded-full bg-slate-100",children:t.jsx("div",{className:"h-full rounded-full bg-gradient-to-r from-indigo-500 to-indigo-700 transition-all duration-1000 ease-out",style:{width:`${f}%`}})})]}),t.jsxs("div",{className:"mb-2 flex flex-col sm:flex-row gap-3 flex-none","data-aos":"fade-up","data-aos-delay":"150",children:[t.jsxs("div",{className:"relative flex-1",children:[t.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-400",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:t.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2.5,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})}),t.jsx("input",{type:"text",placeholder:"Cari data kehadiran berdasarkan nama atau NIP...",value:h,onChange:e=>v(e.target.value),className:"w-full rounded-xl border border-slate-200 bg-white py-2.5 pl-11 pr-4 text-sm text-slate-800 placeholder-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/10 shadow-sm font-medium"})]}),t.jsx("div",{className:"sm:w-64",children:t.jsxs("select",{value:m,onChange:e=>k(e.target.value),className:"w-full rounded-xl border border-slate-200 bg-white py-2.5 px-4 text-sm text-slate-800 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/10 font-medium cursor-pointer",children:[t.jsx("option",{value:"",children:"Semua Status Pegawai"}),N.map((e,n)=>t.jsx("option",{value:e,children:e},n))]})})]}),t.jsx("div",{className:"overflow-hidden rounded-2xl bg-white border border-slate-200 shadow-sm flex-1 flex flex-col min-h-0","data-aos":"fade-up","data-aos-delay":"200",children:t.jsx("div",{className:"overflow-x-auto flex-1 overflow-y-auto max-h-[300px]",children:t.jsxs("table",{className:"min-w-full divide-y divide-slate-200 relative",children:[t.jsx("thead",{className:"bg-slate-50 sticky top-0 z-10 shadow-sm",children:t.jsxs("tr",{children:[t.jsx("th",{className:"px-6 py-3 text-left text-xs font-extrabold uppercase tracking-wider text-slate-500",children:"No"}),t.jsx("th",{className:"px-6 py-3 text-left text-xs font-extrabold uppercase tracking-wider text-slate-500",children:"Nama Lengkap"}),t.jsx("th",{className:"px-6 py-3 text-left text-xs font-extrabold uppercase tracking-wider text-slate-500",children:"NIP"}),t.jsx("th",{className:"px-6 py-3 text-left text-xs font-extrabold uppercase tracking-wider text-slate-500",children:"Status Pegawai"}),s?.kategori==="harian"?t.jsxs(t.Fragment,{children:[t.jsx("th",{className:"px-6 py-3 text-center text-xs font-extrabold uppercase tracking-wider text-slate-500",children:"Alpha"}),t.jsx("th",{className:"px-6 py-3 text-center text-xs font-extrabold uppercase tracking-wider text-slate-500",children:"Izin"}),t.jsx("th",{className:"px-6 py-3 text-center text-xs font-extrabold uppercase tracking-wider text-slate-500",children:"Sakit"}),t.jsx("th",{className:"px-6 py-3 text-center text-xs font-extrabold uppercase tracking-wider text-slate-500",children:"Lupa Absen"}),t.jsx("th",{className:"px-6 py-3 text-center text-xs font-extrabold uppercase tracking-wider text-slate-500",children:"Total Terlambat"}),t.jsx("th",{className:"px-6 py-3 text-center text-xs font-extrabold uppercase tracking-wider text-slate-500",children:"Aksi"})]}):t.jsxs(t.Fragment,{children:[t.jsx("th",{className:"px-6 py-3 text-left text-xs font-extrabold uppercase tracking-wider text-slate-500",children:"Waktu Hadir"}),t.jsx("th",{className:"px-6 py-3 text-center text-xs font-extrabold uppercase tracking-wider text-slate-500",children:"Status"})]})]})}),t.jsx("tbody",{className:"divide-y divide-slate-100 bg-white",children:g.length===0?t.jsx("tr",{children:t.jsxs("td",{colSpan:"6",className:"px-6 py-10 text-center text-slate-600",children:[t.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"mx-auto h-10 w-10 text-slate-300 mb-1",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:t.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1,d:"M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"})}),t.jsx("p",{className:"text-xs font-semibold",children:"Belum ada peserta yang hadir."})]})}):g.map((e,n)=>t.jsxs("tr",{className:"transition-colors hover:bg-slate-50/50",children:[t.jsx("td",{className:"whitespace-nowrap px-6 py-3.5 text-xs text-slate-500 font-semibold",children:n+1}),t.jsx("td",{className:"whitespace-nowrap px-6 py-3.5",children:t.jsxs("div",{className:"flex items-center gap-3",children:[t.jsx("div",{className:"flex h-8 w-8 items-center justify-center rounded-full bg-indigo-50 border border-indigo-100 text-xs font-bold text-indigo-600",children:e.nama.charAt(0).toUpperCase()}),t.jsx("span",{className:"text-sm font-bold text-slate-800",children:e.nama})]})}),t.jsx("td",{className:"whitespace-nowrap px-6 py-3.5 text-xs text-slate-700 font-semibold font-mono",children:e.nis_nip}),t.jsx("td",{className:"whitespace-nowrap px-6 py-3.5 text-xs text-slate-600",children:e.status_pegawai||"-"}),s?.kategori==="harian"?t.jsxs(t.Fragment,{children:[t.jsx("td",{className:"whitespace-nowrap px-6 py-3.5 text-xs text-red-600 font-bold text-center",children:e.total_alpha||"0"}),t.jsx("td",{className:"whitespace-nowrap px-6 py-3.5 text-xs text-amber-600 font-bold text-center",children:e.total_izin||"0"}),t.jsx("td",{className:"whitespace-nowrap px-6 py-3.5 text-xs text-blue-600 font-bold text-center",children:e.total_sakit||"0"}),t.jsx("td",{className:"whitespace-nowrap px-6 py-3.5 text-xs text-slate-600 font-bold text-center",children:e.total_lupa_absen||"0"}),t.jsx("td",{className:"whitespace-nowrap px-6 py-3.5 text-xs text-orange-600 font-bold text-center",children:e.total_menit_terlambat?e.total_menit_terlambat+" Menit":"0 Menit"}),t.jsx("td",{className:"whitespace-nowrap px-6 py-3.5 text-center",children:t.jsx("button",{onClick:()=>S(e.participant_id,e.nama),className:"inline-flex items-center gap-1.5 rounded-lg bg-indigo-50 px-2 py-1.5 text-xs font-bold text-indigo-700 hover:bg-indigo-100 transition-colors",children:"🖨️ Cetak Rekap"})})]}):t.jsxs(t.Fragment,{children:[t.jsx("td",{className:"whitespace-nowrap px-6 py-3.5 text-xs text-slate-700 font-mono font-semibold",children:e.waktu_hadir}),t.jsxs("td",{className:"whitespace-nowrap px-6 py-3.5 text-center",children:[e.status==="hadir"&&t.jsx("span",{className:"inline-flex items-center gap-1 rounded-full bg-emerald-50 border border-emerald-100 px-2.5 py-0.5 text-xs font-bold text-emerald-700",children:"✓ Hadir"}),e.status==="alpha"&&t.jsx("span",{className:"inline-flex items-center gap-1 rounded-full bg-red-50 border border-red-100 px-2.5 py-0.5 text-xs font-bold text-red-700",children:"✗ Alpha"}),e.status==="izin"&&t.jsx("span",{className:"inline-flex items-center gap-1 rounded-full bg-amber-50 border border-amber-100 px-2.5 py-0.5 text-xs font-bold text-amber-700",children:"! Izin"}),e.status==="sakit"&&t.jsx("span",{className:"inline-flex items-center gap-1 rounded-full bg-blue-50 border border-blue-100 px-2.5 py-0.5 text-xs font-bold text-blue-700",children:"+ Sakit"}),e.status==="lupa_absen"&&t.jsx("span",{className:"inline-flex items-center gap-1 rounded-full bg-slate-100 border border-slate-200 px-2.5 py-0.5 text-xs font-bold text-slate-700",children:"? Lupa Absen"})]})]})]},e.id))})]})})})]})})]})}export{W as default};
