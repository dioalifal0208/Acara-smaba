        ...
        return (
            <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 text-center">
                ...
                <div className="w-full max-w-sm rounded-3xl bg-white border border-emerald-200 shadow-xl p-7">
                    ...
                    <button onClick={() => window.location.reload()} className="w-full rounded-xl bg-slate-100 py-3 text-sm font-bold text-slate-600 transition-all hover:bg-slate-200">
                        Tutup
                    </button>
                </div>
            </div>
                ...
                <div className="relative bg-black w-full aspect-[3/4] flex flex-col items-center justify-center">
                    {errorMsg ? (
                        <div className="px-6 text-center z-10">
                            ...
                            <button onClick={() => window.location.reload()} className="rounded-xl bg-white/20 px-6 py-2.5 text-sm font-bold text-white hover:bg-white/30 backdrop-blur-sm">
                                Coba Lagi
                            </button>
                        </div>
                    ) : (
